            ...
            sourceCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat('/me This bot was created by ' + botCreator + ', but was modifed and is maintained by our Manager, ' + botMaintainer + ".");
                    }
                }
            },
            ...
            frasierCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat(subChat("@Frasier-Method is the shit!"));
                    }
                }
            },
